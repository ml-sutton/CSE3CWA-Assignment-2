...
export const RepoStats: React.FC = () => {
  ...
  // }, [hasRendered])
  // refactor this to use serverside props on the page
  return (
    <div className="py-8 lg:px-8">
      <p className="w-fit lg:px-4 lg:w-max text-2xl text-center text-[#fefefe] text-shadow-black text-shadow-md">This project was built in {0} commits using {0} branches and with {0} PRs on <Link className="tracking-normal hover:tracking-widest transition-all" href="https://github.com/ml-sutton/cse3cwa_assignment1">Github</Link> </p>
      <br />
      <SVGLineup />
    </div>
  )
